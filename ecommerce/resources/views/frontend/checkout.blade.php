                        ...
                        <div class="col-lg-6">
                            <div class="axil-checkout-billing">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" id="phone" value="{{ auth('customer')->user()->phone ?? null }}" placeholder="Phone">
                                </div>
                                <div class="form-group">
                                    <label>Email Address <span>*</span></label>
                                    <input type="email" id="email" value="{{ auth('customer')->user()->email ?? null }}" placeholder="Email">
                                </div>
